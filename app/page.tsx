...
export default function Home() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#111b21", fontFamily: "'Segoe UI', Helvetica, Arial, sans-serif", color: "#e9edef" }}>
      <Navbar />

      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 40, paddingTop: 100 }}>
        {/* Title */}
        ...
        <div style={{ display: "flex", gap: 24, flexWrap: "wrap", justifyContent: "center" }}>
          <div
            ...
            style={{ width: 320, padding: "32px 28px", background: "#202c33", borderRadius: 16, cursor: "pointer", border: "1px solid #2a3942", transition: "all 0.2s" }}
          ...
          >
            ...
            <p style={{ fontSize: 14, color: "#8696a0", lineHeight: "20px" }}>View and manage your properties, tenants, owners, vendors, leases, and maintenance tasks. Ask AI questions about your data.</p>
          ...
          >
            ...
            <p style={{ fontSize: 14, color: "#8696a0", lineHeight: "20px" }}>WhatsApp-style messaging dashboard. AI agent Alex auto-replies to tenants, prospects, owners, and vendors.</p>
            <div style={{ marginTop: 16, fontSize: 13, color: "#00a884", fontWeight: 500 }}>Open Messages →</div>
          </div>
        </div>

        <p style={{ fontSize: 12, color: "#667781", marginTop: 20 }}>Powered by Groq AI • DoorLoop • OpenPhone</p>
      </div>
    </div>
  );
}